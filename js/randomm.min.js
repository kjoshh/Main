...
const commands = {
  ...
  inspect: () => {
    ...
    function updateUptime() {
      ...
      // Assuming appendOutputWithTyping can update the existing text,
      // otherwise you might need to clear and rewrite the whole thing.
      appendOutputWithTyping(updatedInspectText, null);
    }

    // Update the uptime every minute (60000 milliseconds)
...
function initializeTerminalScript() {
  ...
  appendOutputWithTyping(banner, () => {
    const initialMessage =
      "\nLast login by kernjosh.com: 11th Feb 2025, 14:46 CET\n\n**********************************************************\n*****  Type 'help' for a list of available commands  *****\n*****  Type 'exit' to return to the previous screen  *****\n**********************************************************\n\n";
